...
imds = imageDatastore(fullfile(rootFolder, 'Adult_Processed_data', categories), ...
    'LabelSource', 'foldernames', ...
...
rho = 0.2; 
phi = 0.5; 
Nf = 400; % Set number of selected features
% Ant Colony System
